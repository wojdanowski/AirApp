export const AIR_API_URL = 'https://air-data-api.herokuapp.com/api/';
export const GIOS_API_URL = 'http://api.gios.gov.pl/pjp-api/rest/';
export const MAP_BOX_API_URL =
...
export const MAP_BOX_QUERY_OPT =
